...
add_image_size( 'top_banner_img', 1600, 637, true );

/*******Start of Custom post services *******/
...
/*******End of Custom post services *******/

$labels = array(
'name' => __('Gallery category'),
'singular_name' => __('Gallery category', 'Gallery category' ),
'search_items' => __( 'Search Gallery category' ),
'all_items' => __( 'Gallery category category' ),
...
register_taxonomy( 'gallery_category', array( 'gallery_category' ), $args );
